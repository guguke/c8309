		...
		phy_interface_t interface)
{
	...
	if (IS_ERR(phydev)){
		printk(KERN_ERR " === fec phy , is err phydev\n");
		return phydev;
        }
	else printk(KERN_ERR " === fec phy , no err phydev\n");
		...
		const char *phy_id, u32 flags, phy_interface_t interface)
{
	...
	printk(KERN_ERR " == phy attach 000\n");
	...
	printk(KERN_ERR " == phy attach 001\n");
	...
	printk(KERN_ERR " == phy attach 002\n");
