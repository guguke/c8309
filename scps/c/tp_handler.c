...
#ifdef DEBUG_GATEWAY
      logEventv(to, e_gateway, "to_be_moved = %d %d %d %d %d\n",
...
#ifdef DEBUG_GATEWAY
	      logEventv (to, e_gateway, "In gateway_move_data %d bytes %d\n", to_be_moved, tmp);
#endif /* DEBUG_GATEWAY */
	    }
	  else
	    {
	      from->gateway_flags |= GATEWAY_MORE_TO_WRITE;
#ifdef DEBUG_GATEWAY
	      logEventv(from, e_gateway, "In gateway_move_data CAN'T WRITE DATA!\n");
#endif /* DEBUG_GATEWAY */
	    }
...
#ifdef DEBUG_GATEWAY
  logEventv(s, e_gateway, "gateway_set_options sockid(%d) divert_port(%d) other(%d)\n",
...
#ifdef DEBUG_GATEWAY
	  logEventv(s, e_gateway, "Case 0:\n");
	  logEventv(s, e_gateway, "  divert_port(%d) = gw_ifs.aif_divport (%d)", divert_port);
	  logEventv(s, e_gateway, "  buffer_size        = %u\n", buffer_size);
	  logEventv(s, e_gateway, "  congestion control = %d\n", gw_ifs.aif_cc);
#endif /* DEBUG_GATEWAY */
...
#ifdef DEBUG_GATEWAY
	  logEventv(s, e_gateway, "Case 0:\n");
	  logEventv(s, e_gateway, "  divert_port = gw_ifs.bif_divport");
	  logEventv(s, e_gateway, "  buffer_size        = %u\n", buffer_size);
	  logEventv(s, e_gateway, "  congestion control = %d\n", gw_ifs.bif_cc);
#endif /* DEBUG_GATEWAY */
...
#ifdef DEBUG_GATEWAY
	  logEventv(s, e_gateway, "Case 1:\n");
	  logEventv(s, e_gateway, "  divert_port = gw_ifs.aif_divport");
	  logEventv(s, e_gateway, "  buffer_size        = %u\n", buffer_size);
	  logEventv(s, e_gateway, "  congestion control = %d\n", gw_ifs.bif_cc);
#endif /* DEBUG_GATEWAY */
