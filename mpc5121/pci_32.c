...
fixup_hide_host_resource_fsl(struct pci_dev* dev)
{
	...
	if ((class == PCI_CLASS_PROCESSOR_POWERPC || class == PCI_CLASS_BRIDGE_OTHER) &&
...
pci_busdev_to_OF_node(struct pci_bus *bus, int devfn)
{
	...
	DBG("pci_busdev_to_OF_node(%d,0x%x)   caller:%pS,%pS\n", bus->number, devfn,__builtin_return_address(0),
