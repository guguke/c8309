...
proc 8309SOM_init_core {} {
	...
	# LBLAWAR0   - enable, size = 64MB  (uboot)   cyx 
	mem [IMMR 0x24] = 0x80000019 
	...
	# DDRLAWAR0  - enable, size = 512MB               cyx
	mem [IMMR 0xA4] = 0x8000001c 
    ...
    # uboot 0x8001.4202        14x10               cyx
	mem [IMMR 0x2080] = 0x80840202
	...
	# BR0 base address at 0xff800000, port size 8 bit, GPCM, valid         cyx
	mem [IMMR 0x5000] = 0xff800801  
	...
	# CS2 - NAND Flash 32 KB                        cyx
	# BR1 base address at 0xF0000000, port size 8 bit, FCM, valid
	mem [IMMR 0x5010] = 0xf0000c21 
	# OR1 32KB size
	#writemem.l 0xe000500c 0xFFFF8796 
	mem [IMMR 0x5014] = 0xFFFF8796 
