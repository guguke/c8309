...
#define MX51_PAD_EIM_CS2__GPIO_2_27	IOMUX_PAD(0x47c, 0x0e8, 1, 0x0,   0, 0x45)
...
#if 0
//////////////////// para zy uboot
#define MX51_PAD_DI2_PIN3__FEC_MDIO			IOMUX_PAD(0x750, 0x348, 2, 0x954, 1, 0x0)
#define MX51_PAD_DI2_DISP_CLK__FEC_RDAT1	IOMUX_PAD(0x754, 0x34c, 2, 0x95c, 1, 0x0)
#define MX51_PAD_DI_GP4__FEC_RDAT2			IOMUX_PAD(0x758, 0x350, 2, 0x960, 1, 0x0)
#define MX51_PAD_DISP2_DAT0__FEC_RDAT3		IOMUX_PAD(0x75c, 0x354, 2, 0x964, 1, 0x0)
#define MX51_PAD_DISP2_DAT1__FEC_RX_ER		IOMUX_PAD(0x760, 0x358, 2, 0x970, 1, 0x0)
#define MX51_PAD_DI2_PIN4__FEC_CRS			IOMUX_PAD(0x748, 0x340, 2, 0x950, 1, 0x0)
#define MX51_PAD_DISP2_DAT10__FEC_COL		IOMUX_PAD(0x784, 0x37c, 2, 0x94c, 1, 0x0)
#define MX51_PAD_DISP2_DAT11__FEC_RXCLK		IOMUX_PAD(0x788, 0x380, 2, 0x968, 1, 0x0)
#define MX51_PAD_DISP2_DAT15__FEC_TDAT0		IOMUX_PAD(0x798, 0x390, 2, 0x0, 0, 0x2004)  ////      0004
#define MX51_PAD_DISP2_DAT14__FEC_RDAT0		IOMUX_PAD(0x794, 0x38c, 2, 0x958, 1, 0x2180)     ///   0180
#define MX51_PAD_DI_GP3__FEC_TX_ER			IOMUX_PAD(0x744, 0x33c, 2, 0x0, 0, 0x2004)     /////  0004
#define MX51_PAD_DI2_PIN2__FEC_MDC			IOMUX_PAD(0x74c, 0x344, 2, 0x0, 0, 0x2004)     /////  0004
#define MX51_PAD_DISP2_DAT6__FEC_TDAT1		IOMUX_PAD(0x774, 0x36c, 2, 0x0, 0, 0x2004)       ///  0004
#define MX51_PAD_DISP2_DAT7__FEC_TDAT2		IOMUX_PAD(0x778, 0x370, 2, 0x0, 0, 0x2004)         /// 0004
#define MX51_PAD_DISP2_DAT8__FEC_TDAT3		IOMUX_PAD(0x77c, 0x374, 2, 0x0, 0, 0x2004)   ///  0004
#define MX51_PAD_DISP2_DAT9__FEC_TX_EN		IOMUX_PAD(0x780, 0x378, 2, 0x0, 0, 0x2004)    //// 0004
#define MX51_PAD_DISP2_DAT13__FEC_TX_CLK	IOMUX_PAD(0x790, 0x388, 2, 0x974, 1, 0x2180)    /// 0180
#define MX51_PAD_DISP2_DAT12__FEC_RX_DV		IOMUX_PAD(0x78c, 0x384, 2, 0x96c, 1, 0x0)
#endif
/////////////////////////////////////////////////////////////////////////-----------------------
#define MX51_PAD_DI2_PIN3__FEC_MDIO			IOMUX_PAD(0x750, 0x348, 2, 0x954, 1, 0x1fd)
#define MX51_PAD_DI2_DISP_CLK__FEC_RDAT1	IOMUX_PAD(0x754, 0x34c, 2, 0x95c, 1, 0x180)
#define MX51_PAD_DI_GP4__FEC_RDAT2			IOMUX_PAD(0x758, 0x350, 2, 0x960, 1, 0x100)
#define MX51_PAD_DISP2_DAT0__FEC_RDAT3		IOMUX_PAD(0x75c, 0x354, 2, 0x964, 1, 0x0)
#define MX51_PAD_DISP2_DAT1__FEC_RX_ER		IOMUX_PAD(0x760, 0x358, 2, 0x970, 1, 0x0)
#define MX51_PAD_DI2_PIN4__FEC_CRS			IOMUX_PAD(0x748, 0x340, 2, 0x950, 1, 0x180)
#define MX51_PAD_DISP2_DAT10__FEC_COL		IOMUX_PAD(0x784, 0x37c, 2, 0x94c, 1, 0x2180)
#define MX51_PAD_DISP2_DAT11__FEC_RXCLK		IOMUX_PAD(0x788, 0x380, 2, 0x968, 1, 0x0)
#define MX51_PAD_DISP2_DAT15__FEC_TDAT0		IOMUX_PAD(0x798, 0x390, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DISP2_DAT14__FEC_RDAT0		IOMUX_PAD(0x794, 0x38c, 2, 0x958, 1, 0x2180)
#define MX51_PAD_DI_GP3__FEC_TX_ER			IOMUX_PAD(0x744, 0x33c, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DI2_PIN2__FEC_MDC			IOMUX_PAD(0x74c, 0x344, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DISP2_DAT6__FEC_TDAT1		IOMUX_PAD(0x774, 0x36c, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DISP2_DAT7__FEC_TDAT2		IOMUX_PAD(0x778, 0x370, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DISP2_DAT8__FEC_TDAT3		IOMUX_PAD(0x77c, 0x374, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DISP2_DAT9__FEC_TX_EN		IOMUX_PAD(0x780, 0x378, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DISP2_DAT13__FEC_TX_CLK	IOMUX_PAD(0x790, 0x388, 2, 0x974, 1, 0x2180)
#define MX51_PAD_DISP2_DAT12__FEC_RX_DV		IOMUX_PAD(0x78c, 0x384, 2, 0x96c, 1, 0x2180)
...
#define MX51_PAD_DI2_PIN3__FEC_MDIO			IOMUX_PAD(0x750, 0x348, 2, 0x954, 1, 0x1fd)
#define MX51_PAD_DI2_DISP_CLK__FEC_RDAT1	IOMUX_PAD(0x754, 0x34c, 2, 0x95c, 1, 0x180)
#define MX51_PAD_DI_GP4__FEC_RDAT2			IOMUX_PAD(0x758, 0x350, 2, 0x960, 1, 0x180)
#define MX51_PAD_DISP2_DAT0__FEC_RDAT3		IOMUX_PAD(0x75c, 0x354, 2, 0x964, 1, 0x180)
#define MX51_PAD_DISP2_DAT1__FEC_RX_ER		IOMUX_PAD(0x760, 0x358, 2, 0x970, 1, 0x180)
#define MX51_PAD_DI2_PIN4__FEC_CRS			IOMUX_PAD(0x748, 0x340, 2, 0x950, 1, 0x180)
#define MX51_PAD_DISP2_DAT10__FEC_COL		IOMUX_PAD(0x784, 0x37c, 2, 0x94c, 1, 0x2180)
#define MX51_PAD_DISP2_DAT11__FEC_RXCLK		IOMUX_PAD(0x788, 0x380, 2, 0x968, 1, 0x2180)
#define MX51_PAD_DISP2_DAT15__FEC_TDAT0		IOMUX_PAD(0x798, 0x390, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DISP2_DAT14__FEC_RDAT0		IOMUX_PAD(0x794, 0x38c, 2, 0x958, 1, 0x2180)
#define MX51_PAD_DI_GP3__FEC_TX_ER			IOMUX_PAD(0x744, 0x33c, 2, 0x0, 0, 0x2004)
#define MX51_PAD_DI2_PIN2__FEC_MDC			IOMUX_PAD(0x74c, 0x344, 2, 0x0, 0, 0x2004)
...
/////////// bbg kernel org
#define MX51_PAD_DI2_PIN3__FEC_MDIO			IOMUX_PAD(0x750, 0x348, 2, 0x954, 1, MX51_PAD_CTRL_1 | PAD_CTL_PUS_22K_UP)
#define MX51_PAD_DI2_DISP_CLK__FEC_RDAT1	IOMUX_PAD(0x754, 0x34c, 2, 0x95c, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DI_GP4__FEC_RDAT2			IOMUX_PAD(0x758, 0x350, 2, 0x960, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DISP2_DAT0__FEC_RDAT3		IOMUX_PAD(0x75c, 0x354, 2, 0x964, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DISP2_DAT1__FEC_RX_ER		IOMUX_PAD(0x760, 0x358, 2, 0x970, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DI2_PIN4__FEC_CRS			IOMUX_PAD(0x748, 0x340, 2, 0x950, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DISP2_DAT10__FEC_COL		IOMUX_PAD(0x784, 0x37c, 2, 0x94c, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DISP2_DAT11__FEC_RXCLK		IOMUX_PAD(0x788, 0x380, 2, 0x968, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DISP2_DAT15__FEC_TDAT0		IOMUX_PAD(0x798, 0x390, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_DISP2_DAT14__FEC_RDAT0		IOMUX_PAD(0x794, 0x38c, 2, 0x958, 1, MX51_PAD_CTRL_2)
#define MX51_PAD_DI_GP3__FEC_TX_ER			IOMUX_PAD(0x744, 0x33c, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_DI2_PIN2__FEC_MDC			IOMUX_PAD(0x74c, 0x344, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_DISP2_DAT6__FEC_TDAT1		IOMUX_PAD(0x774, 0x36c, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_DISP2_DAT7__FEC_TDAT2		IOMUX_PAD(0x778, 0x370, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_DISP2_DAT8__FEC_TDAT3		IOMUX_PAD(0x77c, 0x374, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_DISP2_DAT9__FEC_TX_EN		IOMUX_PAD(0x780, 0x378, 2, 0x0, 0, MX51_PAD_CTRL_5)
#define MX51_PAD_DISP2_DAT13__FEC_TX_CLK	IOMUX_PAD(0x790, 0x388, 2, 0x974, 1, MX51_PAD_CTRL_4)
#define MX51_PAD_DISP2_DAT12__FEC_RX_DV		IOMUX_PAD(0x78c, 0x384, 2, 0x96c, 1, MX51_PAD_CTRL_2)
#endif
